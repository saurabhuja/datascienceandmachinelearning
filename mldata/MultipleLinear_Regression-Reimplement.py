...
# =============================================================================
X = dataset.iloc[:,[0,2]].values       # X 2d numpy array
...
mse = mean_squared_error(y_test,y_pred)   # 67220275.37568113
rmse = np.sqrt(mse)                       # 8198.797190788484
score = r2_score(y_test,y_pred)          # 0.9474386447268489
