# -*- coding: utf-8 -*-
"""
Predict Continuous Values- ReImplement- 2 features (RND & MKT)
@author: tsecl
"""
...
# =============================================================================
X = dataset.iloc[:,[0,1,2]].values       # X 2d numpy array
...
mse = mean_squared_error(y_test,y_pred)   # 77506468.16885403
rmse = np.sqrt(mse)                       # 8803.775790469339
score = r2_score(y_test,y_pred)          # 0.9393955917820571
