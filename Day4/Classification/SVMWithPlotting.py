...
classifier.support_vectors_     # supporting vector data points values

classifier.support_          # supporting vector data points index

classifier.n_support_        # number of supporting vectors from each class
